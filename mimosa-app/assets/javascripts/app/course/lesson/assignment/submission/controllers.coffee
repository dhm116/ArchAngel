define ['angular'], (angular) ->
    return angular.module('djangoApp.controllers').controller 'GradeController', ($scope, $routeParams, Restangular, Course, CourseSection, Lesson, Assignment, AssignmentSubmission) ->
        # $scope.user = User
