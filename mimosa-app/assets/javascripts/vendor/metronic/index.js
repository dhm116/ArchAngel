var Index = function () {
    ...
    return {
        ...
        //main function
        init: function () {
            Metronic.addResponsiveHandler(function () {
        ...
        initCalendar: function () {
            ...
            $('#calendar').fullCalendar({ //re-initialize the calendar
                ...
                events: [{
                        ...
                        backgroundColor: Metronic.getLayoutColorCode('yellow')
                    }, {
                        title: 'Long Event',
                        start: new Date(y, m, d - 5),
                        end: new Date(y, m, d - 2),
                        backgroundColor: Metronic.getLayoutColorCode('green')
                    }, {
                        title: 'Repeating Event',
                        start: new Date(y, m, d - 3, 16, 0),
                        allDay: false,
                        backgroundColor: Metronic.getLayoutColorCode('red')
                    }, {
                        title: 'Repeating Event',
                        ...
                        backgroundColor: Metronic.getLayoutColorCode('grey'),
                        allDay: false,
                    }, {
                        title: 'Birthday Party',
                        start: new Date(y, m, d + 1, 19, 0),
                        end: new Date(y, m, d + 1, 22, 30),
                        backgroundColor: Metronic.getLayoutColorCode('purple'),
                        allDay: false,
                    }, {
        ...
        initMiniCharts: function () {
            ...
            $('.easy-pie-chart .number.transactions').easyPieChart({
                ...
                size: 75,
                lineWidth: 3,
                barColor: Metronic.getLayoutColorCode('yellow')
            });
            ...
            $('.easy-pie-chart .number.visits').easyPieChart({
                ...
                size: 75,
                lineWidth: 3,
                barColor: Metronic.getLayoutColorCode('green')
            });
            ...
            $('.easy-pie-chart .number.bounce').easyPieChart({
                ...
                size: 75,
                lineWidth: 3,
                barColor: Metronic.getLayoutColorCode('red')
            });
