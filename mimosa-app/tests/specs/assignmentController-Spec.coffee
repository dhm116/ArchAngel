#*******
# Testing assignment controller as defined in app/course/assignment/controllers.coffee
#
#  C.Wolf, 11/14/13
#
#
...
#*******
#
#  the assignment controller scope contains the following properties:
#    TBD
#

define ['app/app', 'app/course/assignment/controllers', 'app/course/assignment/services', 'angular', 'angular-mocks', 'angular-route', 'restangular'
        'underscore', 'ngStorage', 'loading-bar', 'markdown'], 
(app, ctrl, svc, angular) ->


    describe 'AssignmentControllers unit testing:', ->
