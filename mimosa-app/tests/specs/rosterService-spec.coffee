#*******
# Testing roster services as defined in app/course/roster/services.coffee
#
#  C.Wolf, 11/14/13
#
...
#*******
#
#  Roster Services consist of TBD 
#
#  The expected service API is as follows:
#
#  TBD

define ['app/app', 'app/course/roster/services', 'angular', 'angular-route', 'restangular'
        'underscore', 'ngStorage', 'loading-bar', 'markdown'], 
(app, svc, angular) ->
    describe 'RosterServices unit testing:', ->
