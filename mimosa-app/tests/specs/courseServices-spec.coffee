#*******
# Testing course services as defined in app/course/services.coffee
#
#  C.Wolf, 11/14/13
#
...
#*******
#
#  Course Services consist of TBD 
#
#  The expected service API is as follows:
#
#  TBD

define ['app/app', 'app/course/services', 'angular', 'angular-route', 'restangular'
        'underscore', 'ngStorage', 'loading-bar', 'markdown'], 
(app, svc, angular) ->
    describe 'CourseServices unit testing:', ->
