#*******
# Testing assignment services as defined in app/course/assignment/services.coffee
#
#  C.Wolf, 11/14/13
#
...
#*******
#
#  Assignment Services consist of TBD 
#
#  The expected service API is as follows:
#
#  TBD

define ['app/app', 'app/course/assignment/services', 'angular', 'angular-route', 'restangular'
        'underscore', 'ngStorage', 'loading-bar', 'markdown'], 
(app, svc, angular) ->
    describe 'AssignmentServices unit testing:', ->
