#*******
# Testing syllabus services as defined in app/course/syllabus/services.coffee
#
#  C.Wolf, 11/14/13
#
...
#*******
#
#  Syllabus Services consist of TBD 
#
#  The expected service API is as follows:
#
#  TBD

define ['app/app', 'app/course/syllabus/services', 'angular', 'angular-route', 'restangular'
        'underscore', 'ngStorage', 'loading-bar', 'markdown'], 
(app, svc, angular) ->
    describe 'SyllabusServices unit testing:', ->
